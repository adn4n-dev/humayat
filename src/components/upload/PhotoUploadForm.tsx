    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="space-y-2">
            ...
            <div
              className={`border-2 border-dashed rounded-lg p-6 text-center ${
                photoUrl ? 'border-indigo-300' : 'border-gray-300 hover:border-indigo-300'
              }`}
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                className="ml-2 p-2 bg-indigo-100 text-indigo-700 rounded-md hover:bg-indigo-200 transition-colors duration-200"
              >
      ...
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end">
        ...
        <button
          ...
          className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition duration-300 flex items-center disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {isSubmitting ? (
            <>
